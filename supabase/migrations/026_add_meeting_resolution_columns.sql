-- =========================================================
-- Migration: Add missing meeting resolution columns
-- Purpose:
--   Align the live meetings table with the host/admin meeting
--   resolution flow already used throughout the app.
-- =========================================================
...
CREATE INDEX IF NOT EXISTS idx_meetings_finalized_at
  ON public.meetings(finalized_at DESC NULLS LAST);

CREATE INDEX IF NOT EXISTS idx_meetings_admin_resolved_at
  ON public.meetings(admin_resolved_at DESC NULLS LAST);

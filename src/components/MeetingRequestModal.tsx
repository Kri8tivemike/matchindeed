...
import { MEETING_REQUEST_LEAD_TIME_HOURS } from "@/lib/meetings/request-availability";
        ...
        <div className="flex-1 space-y-4 overflow-y-auto p-4">
          ...
          {!tierPermission?.allowed && tierPermission ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-sm text-gray-400">
                This user has no requestable availability at least {MEETING_REQUEST_LEAD_TIME_HOURS} hours away.
              </p>
            </div>
          ) : (
            <div className="space-y-4">
              <div className="space-y-1">
                ...
                <p className="text-[11px] leading-relaxed text-gray-500 sm:text-xs">
                  ...
                  Only times at least {MEETING_REQUEST_LEAD_TIME_HOURS} hours away are shown.
                </p>
              </div>
